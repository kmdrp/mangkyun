    ...
    <div id="login_body">
        <div id="login_form">
            <form action="/join" method="post">
                ...
                <input type="text" class="form-control" name="nickname" placeholder="Enter Nickname"><br>
                <button type="submit" class="btn btn-default button_example">가 입</button>
            </form>
            <a href="/board/index.jsp" style="color:#1E90FF;text-align: center;">로그인</a>
        </div>
    </div>
</body>
</html>
